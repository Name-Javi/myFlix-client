...
export class ProfileView extends React.Component {
  constructor() {
    super();
    (this.Username = null), (this.Password = null), (this.Email = null), (this.Birthdate = null);
    this.state = {
      Username: null,
      Password: null,
      Email: null,
  ...
  getUser(token) {
    ...
    axios
      .get(`https://javisolismyflix.herokuapp.com/users/${username}`, {
  ...
  handleRemoveFavorite(e, movie) {
    ...
    axios
      .delete(`https://javisolismyflix.herokuapp.com/users/${username}/movies/${movie}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
